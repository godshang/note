...
<img src="./image/4235178-2d83a09abf0a3436.png" />
...
<img src="./image/4235178-4047d3c78bb467c9.png" />
...
<img src="./image/4235178-d570de7505817605.png" />
...
<img src="./image/4235178-929a4d5e00c5e779.png" />
...
4. 当有 I/O 事件就绪时，相关的 subReactor 将事件派发给相应的处理器。这里 subReactor 线程负责完成 I/O 的 `read()`；读取数据后可将业务逻辑提交到线程池，业务完成后再把相应的写事件交回 subReactor 线程处理。
